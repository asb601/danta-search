...
class Settings(BaseSettings):
    ...
    EXECUTION_RETRIEVAL_MAX_TABLES: int = 12
    EXECUTION_RETRIEVAL_DEEP_WORKFLOW_MAX_TABLES: int = 15
    EXECUTION_RETRIEVAL_MULTI_DOMAIN_MAX_TABLES: int = 20
    EXECUTION_RETRIEVAL_SUPPRESS_TRANSFORMED: bool = True
    ...
    SEMANTIC_DOMAIN_CONSOLIDATION_ON_INGEST: bool = False
